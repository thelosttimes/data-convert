package com.my.dataconvert.model;
/**
...
public class TableEntity implements Comparable<TableEntity> {
	...
	private String table_from_where;
	
	private String table_from_pageSize;
	...
	public String getTable_from_where() {
		return this.table_from_where;
	}

	public void setTable_from_where(String table_from_where) {
		this.table_from_where = table_from_where;
	}

	public String getTable_from_pageSize() {
		return this.table_from_pageSize;
	}

	public void setTable_from_pageSize(String table_from_pageSize) {
		this.table_from_pageSize = table_from_pageSize;
	}
